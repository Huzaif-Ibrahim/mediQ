...
const DocInfo = () => {
    ...
    const { doctors, backend_url, navigate, token, fetchDoctors } = useContext(AppContext)
            ...
            <div className='pt-6 min-h-screen'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-[1fr_3fr] lg:gap-4 py-0 lg:pt-6 -translate-y-8 lg:translate-y-0'>
                    ...
                    <div className='w-full overflow-hidden'>
                        ...
                        <button onClick={submitHandler} className='px-24 flex items-center justify-center text-sm w-full lg:w-fit py-3 cursor-pointer bg-[#4fd19f] text-white rounded-full mt-4'>{loading ? <div role="status">
